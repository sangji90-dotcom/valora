...
export interface SiteConfig {
  ...
  /**
   * 제품 상세의 "유의사항" 탭에 들어갈 안내입니다.
   *
   * 최소 주문 수량·납기·교환 기준처럼 **모든 제품에 공통**인 내용을 둡니다.
   * 제품마다 다른 값은 각 제품의 specs 에 넣으세요.
   *
   * 비워두면 탭 자체가 나오지 않습니다.
   *
   * ⚠ 결제·배송이 없는 카탈로그라 "환불 규정"을 적으면 안 됩니다.
   *   판매 계약은 별도로 맺는 구조이므로, 여기에는 문의 단계에서
   *   알아야 할 것만 적으세요.
   */
  productNotice?: {
    /** 탭 이름. 기본 '유의사항' */
